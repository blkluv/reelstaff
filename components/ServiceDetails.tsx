...
import { Service } from '@/types' // Change from Product to Service
import { 
  ShoppingCart, 
  Package, 
  Truck, 
...
interface ServiceDetailsProps { // Change interface name
  service: Service // Change from product to service
}

export default function ServiceDetails({ service }: ServiceDetailsProps) { // Change function name and parameter
